 #include<reg51.h>
    ...
    */
    ...
    sbit E    = P3^4;     //E pin for LCD
    sbit RS   = P3^2;     //RS pin for LCD
    sbit RW   = P3^3;     //RS pin for LCD
    // ***********************************************************
    // Main program
    //
    int main(void)
    ...
    {   
        ...
        if (C2 == 0) { delay(10000); while (C2==0); return 'C'; }
        if (C3 == 0) { delay(10000); while (C3==0); return 'B'; }
        if (C4 == 0) { delay(10000); while (C4==0); return 'A'; }
        ...
        if (C1 == 0) { delay(10000); while (C1==0); return '*'; }
        if (C2 == 0) { delay(10000); while (C2==0); return '7'; }
        if (C3 == 0) { delay(10000); while (C3==0); return '4'; }
